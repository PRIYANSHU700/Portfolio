  ...
  return (
    <div className={styles.section1outer}>
      ...
      <div className={styles.left}>
        ...
        <button onClick={() => window.open("https://docs.google.com/document/d/1ZDMjKy_5bn8PoY-crZL_LbXv18Yj2KUX/edit?usp=sharing&ouid=110881023256295559243&rtpof=true&sd=true", '_blank')} className={styles.ctaButton}>  Download CV <span className={styles.pointer}>👈</span></button>
